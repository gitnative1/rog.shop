...
export default function SignUpPhoto() {
  ...
  const onSubmit = async () => {
    ...
    if (result?.error) {
      ...
      toast.success('Register Berhasil', { theme: 'colored' });
            ...
            <form action="">
                <div className="form-input d-md-block d-flex flex-column">
                    ...
                    <div className="button-group d-flex flex-column mx-auto">
                        <button type="button" className="btn btn-create fw-medium text-lg text-white rounded-pill mb-16" onClick={onSubmit}>Create My Account</button>
